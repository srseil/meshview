...
You can use WASD to move the first-person camera around, and the left mouse button to drag the camera view direction. F12 creates a screenshot and saves it as a PNG file in the output directory.
